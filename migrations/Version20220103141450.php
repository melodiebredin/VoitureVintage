 ...
 */
final class Version20220103141450 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cart_vehicle (cart_id INT NOT NULL, vehicle_id INT NOT NULL, INDEX IDX_E05A2C811AD5CDBF (cart_id), INDEX IDX_E05A2C81545317D1 (vehicle_id), PRIMARY KEY(cart_id, vehicle_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
